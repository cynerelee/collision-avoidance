...
plt.plot(x, d10_data,alpha=0.6,label='$K_2=25$',color=color[4],linewidth=2)
plt.plot(x, d27_data,alpha=0.6,label='$K_2=27$',color=color[4],linewidth=2)
plt.legend(loc = 0,prop=font2)

plt.savefig('deviation_K2_1.png')
