...
d10 = 'deviation_20.mat'
d10_data = scio.loadmat(d10)['Deviation']



d27 = 'deviation_27.mat'
d27_data = scio.loadmat(d27)['Deviation']
...
plt.plot(x, d10_data,alpha=0.6,label='$K_3=20$',color=color[4],linewidth=2)
plt.plot(x, d27_data,alpha=0.6,label='$K_3=27$',color=color[5],linewidth=2)
plt.legend(loc = 0,prop=font2)

plt.savefig('deviation_K3_1.png')
