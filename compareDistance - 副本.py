...
d2 = 'K2/d_after_25.mat'
d2_data = scio.loadmat(d2)['d_after']

d3 = 'K3/d_after_20.mat'
d3_data = scio.loadmat(d3)['d_after']
...
#plt.plot(x, d5_data,alpha=0.6,label='K1=5',color=color[3],linewidth=2)
#plt.plot(x, d10_data,alpha=0.6,label='K1=10',color=color[4],linewidth=2)
plt.legend(loc = 0,prop=font2)

plt.savefig('Comparedistance_1.png')
